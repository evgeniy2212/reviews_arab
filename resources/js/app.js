    ...
    $( document ).ready(function() {
        ...
        $('.js-chat-contact').on('click', function () {
            if($(this).data('name') !== undefined){
                if($(this).data('current-status') == 1){
                    $('.current__contact__name').parent().addClass('is-online')
                } else {
                    $('.current__contact__name').parent().removeClass('is-online')
                }
                $('.current__contact__name').text(
                    $(this).data('name')
                );
                $('.current__contact__status__name').text(
                    $(this).data('status')
                );
            }
