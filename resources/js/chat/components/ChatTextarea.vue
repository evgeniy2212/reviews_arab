<template>
    <div>
        ...
        <div class="chat__buttons six__mod">
            <a data-tooltip="بادئ ذي بدء ، تحتاج إلى تحديد المراجعة المطلوبة بالنقر فوق الزر &quot;يفتح&quot;"
               class="chat__close"
            ...
            <button class="chat__close"
                    data-tooltip="بادئ ذي بدء ، تحتاج إلى تحديد المراجعة المطلوبة بالنقر فوق الزر &quot;يفتح&quot;"
                    @click="sendLink"
                    type="button">وصلة</button>
            <button class="chat__close"
...
export default {
    ...
    methods: {
        ...
        sendLink(){
            let message = '<a href="' + window.location.href + '" target="_blank">افتح الرابط</a>';
            this.sendMessage(message, false);
        },
